...
Download the [Unit 2 Task 1 Template](../../Templates/Unit_2/assignment_1/unit2_task1_template.qmd). Note: batting average is number of hits divided by the number of at-bats. It is a number between 0 and 1 that represents what % of the time a player gets a hit (as opposed to getting out, for example).
...
_Use this [unit2_task1_template](../../Templates/Unit_2/assignment_1/unit2_task1_template.qmd) to submit your Client Report._
