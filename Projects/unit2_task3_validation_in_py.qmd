---
resource_id: "923162e4-eac4-4ba8-83fd-173a3b51ffe0"
...
<!-- section_id: "d5753be1-f14f-4433-8bad-58ac85e6d610" -->
### Background
...
It is rare for an analysis to rely solely on one table. In fact, that is the whole point of a relational database: to quickly and easily tie tables together. Many students have already learned how to join tables using SQL. This assignment gives you practice joining tables using Python Pandas code. Students inevitably ask, "if I can do the same thing in both languages, why/when would I chose one over the other?". [This thread](https://datascience.stackexchange.com/questions/34357/why-do-people-prefer-pandas-to-sql) has some good thoughts on the topic.  


<!-- section_id: "1916ab80-8e3d-4577-a480-d9bf144975e1" -->
### Client Request
...
<!-- section_id: "e5499dce-0050-4700-b386-5a16ea7ceeb1" -->
### Data
...
<!-- section_id: "fdf95ee2-67ed-4851-ae77-c51a7b414e4c" -->
### Readings
...
- [P4DS: CH13 Exploratory Data Analysis](https://aeturrell.github.io/python4DS/exploratory-data-analysis.html) Skim to see many different possible geoms to use depending on the data types and to see some of the commands from CH4 again. 
- __[P4DS: CH4 Data Transformation]__(https://aeturrell.github.io/python4DS/data-transform.html#) as review


<!-- section_id: "8ffaa03f-671e-4180-b9d1-6fea457faa7b" -->
### Questions and Tasks

Download the [template for this task](../Templates/unit2_task3_validation_template.qmd).

1. __Write an SQL query that pulls in the the salaries table and the collegeplaying table (and any other tables you might need) and store them in pandas dataframes. Combine the dataframes to create a list of baseball players who attended BYU-Idaho. The new table should contain five columns: playerID, schoolID, salary, and the yearID and teamID associated with each salary.__
...
<!-- section_id: "4d758cc6-1925-4b43-bada-303ff5e71968" -->
### Submission:
::: {.callout-note collapse="true"}
...
<!-- section_id: "86f1a2ee-dda2-48df-b6eb-0c6d99cf5524" -->
### Deliverables:

_Use this [task's template](../Templates/unit2_task3_validation_template.qmd) to submit your Client Report._
