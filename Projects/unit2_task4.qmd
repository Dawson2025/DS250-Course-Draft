...
For this project, the Client wants you to use Python pandas for data manipulation and analysis. They would also like to see the results in Lets-Plot charts.
